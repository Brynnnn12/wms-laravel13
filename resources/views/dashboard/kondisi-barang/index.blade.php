    ...
    <div class="py-8">
        <div class="w-full max-w-[96rem] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p class="text-emerald-100 text-sm mt-2">
                                Kelola data kondisi barang pada sistem inventory.
                            </p>
                        </div>

                        <a href="{{ route('kondisi-barang.create') }}"
            ...
            <form id="bulk-delete-form"
                  data-bulk-delete
                  action="{{ route('kondisi-barang.bulk-delete') }}"
                  method="POST">
                    ...
                    <div class="px-6 py-5 border-b border-slate-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">
                                Daftar seluruh kondisi barang yang tersedia.
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button"
                                    id="bulk-delete-btn"
                                    data-delete-button
                                    data-confirm-message="Apakah Anda yakin ingin menghapus kondisi barang yang dipilih?"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-slate-100">
                                @forelse($kondisiBarangs as $index => $item)
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            {{ $kondisiBarangs->firstItem() + $index }}
                                        </td>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <a href="{{ route('kondisi-barang.edit', $item) }}"
                                                ...
                                                <button type="button"
                                                        data-confirm-delete
                                                        data-confirm-route="{{ route('kondisi-barang.destroy', $item) }}"
