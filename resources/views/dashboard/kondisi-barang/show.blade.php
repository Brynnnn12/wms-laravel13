                ...
                <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-2">
                            Informasi lengkap kondisi barang.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('kondisi-barang.edit', $kondisi_barang) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Nama Kondisi</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-lg font-bold text-slate-800 mt-1">
                                {{ $kondisi_barang->created_at->format('d M Y') }}
                            </h3>
                        </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="pt-5 border-t border-slate-100">
                            <p class="text-xs text-slate-400 mb-2">
                                Dibuat:
                                {{ $kondisi_barang->created_at?->format('d M Y, H:i') }}
                            </p>

                            <p class="text-xs text-slate-400">
                                Update:
                                {{ $kondisi_barang->updated_at?->format('d M Y, H:i') }}
                            </p>
                        </div>
