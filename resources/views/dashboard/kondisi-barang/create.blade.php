    ...
    <div class="py-8">
        <div class="w-full max-w-[96rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 rounded-3xl bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 p-6 md:p-8 shadow-xl">
                <p class="text-emerald-100 text-sm font-medium mb-2">Kondisi Barang Management</p>
                <h1 class="text-3xl font-bold text-white">Tambah Kondisi Barang Baru</h1>
                <p class="text-emerald-100 text-sm mt-2">
                    Buat kondisi barang baru untuk sistem inventory gudang.
                </p>
            </div>
