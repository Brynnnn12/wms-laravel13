    ...
    <div class="py-8">
        <div class="w-full max-w-[96rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 rounded-3xl bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 p-6 md:p-8 shadow-xl">
                <p class="text-orange-100 text-sm font-medium mb-2">Inventory Management</p>
                <h1 class="text-3xl font-bold text-white">Edit Ruangan</h1>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form action="{{ route('nama-ruang.update', $nama_ruang) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 md:p-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text"
                                       name="nama_ruang"
                                       value="{{ old('nama_ruang', $nama_ruang->nama_ruang) }}"
                                       required
                            ...
                            <div>
                                ...
                                <select name="lokasi_penyimpanan_id"
                                    ...
                                    @foreach(\App\Models\LokasiPenyimpanan::all() as $lokasi)
                                        <option value="{{ $lokasi->id }}" {{ old('lokasi_penyimpanan_id', $nama_ruang->lokasi_penyimpanan_id) == $lokasi->id ? 'selected' : '' }}>
                                            {{ $lokasi->nama_lokasi }}
                                        </option>
                                    @endforeach
                                </select>
