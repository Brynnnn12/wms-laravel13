                    ...
                    <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p class="text-emerald-100 text-sm mt-2">
                                Kelola data user pada sistem inventory.
                            </p>
                        </div>
                    ...
                    <div class="px-6 py-5 border-b border-slate-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">
                                Daftar seluruh user yang tersedia.
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button"
                                    id="bulk-delete-btn"
                                    data-delete-button
                                    data-confirm-message="Apakah Anda yakin ingin menghapus user yang dipilih?"
                                    ...
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-center gap-2">
                                                ...
                                                <button type="button"
                                                        data-confirm-delete
                                                        data-confirm-route="{{ route('users.destroy', $user) }}"
