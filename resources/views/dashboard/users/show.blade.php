            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-5">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-12 h-12 rounded-2xl {{ $user->is_active ? 'bg-emerald-100' : 'bg-red-100' }} flex items-center justify-center">
                            <i class="fas fa-{{ $user->is_active ? 'check-circle' : 'times-circle' }} {{ $user->is_active ? 'text-emerald-600' : 'text-red-600' }}"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="px-6 py-5 border-b border-slate-100">
                        ...
                        <p class="text-sm text-slate-500 mt-1">
                            Detail lengkap informasi user ini.
                        </p>
                    </div>
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            <p class="text-sm text-slate-500">ID User</p>
                            <p class="font-semibold text-slate-800 mt-1">
                                {{ $user->id }}
                            </p>
                        </div>
