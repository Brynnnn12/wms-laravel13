                ...
                <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm mt-2">
                            Informasi lengkap lokasi penyimpanan.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('lokasi-penyimpanan.edit', $lokasiPenyimpanan) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-5">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Nama Lokasi</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-lg font-bold text-slate-800 mt-1">
                                {{ $lokasiPenyimpanan->created_at->format('d M Y') }}
                            </h3>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="px-6 py-5 border-b border-slate-100">
                        ...
                        <p class="text-sm text-slate-500 mt-1">
                            Detail lengkap lokasi penyimpanan ini.
                        </p>
                    </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <p class="text-sm text-slate-500">Nama Lokasi Penyimpanan</p>
                ...
                <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            <p class="text-sm text-slate-500">ID Lokasi</p>
                            <p class="font-semibold text-slate-800 mt-1">
                                {{ $lokasiPenyimpanan->id }}
                            </p>
                        </div>
                        ...
                        <div class="pt-5 border-t border-slate-100">
                            <p class="text-xs text-slate-400 mb-2">
                                Dibuat:
                                {{ $lokasiPenyimpanan->created_at?->format('d M Y, H:i') }}
                            </p>

                            <p class="text-xs text-slate-400">
                                Update:
                                {{ $lokasiPenyimpanan->updated_at?->format('d M Y, H:i') }}
                            </p>
                        </div>
